...
阅读自机相关的data内容对理解自机运行的原理有很大帮助。翻data这件事并不容易，我会帮你作一些整理，但是我仍然非常希望你亲自去读一读data里面相关的内容。如果你不知道如何查看data，也许这里可以帮到你。

要查看data，通常你需要一个代码编辑器，比如 Visual Studio Code（VSCode）。为了方便查阅，通常需要编辑器有全局查找功能，以及对lua语言的语法高亮、查找引用等的支持。我将以VSCode为例介绍查阅自机相关data的方法，如果你在使用其他编辑器也可以适当的参考。如果你在使用记事本，呃，你开心就好......
